...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _loadBackgroundImage() async {
    ...
    final newThemeImage =
        prefs.getString('themeImage') ?? 'assets/images/img0.png';
    setState(() {
  ...
  Color _getTextColor() {
    return _backgroundImage == 'assets/images/img0.png'
        ? Colors.black
        : Colors.white;
  }
        ...
        child: Column(
          children: [
            ...
            _buildListTile(
              ...
              onTap: () {
                Navigator.of(context).push(_customPageRoute(UserInputPage()));
                // Navigator.push(
                //   context,
  ...
  Widget _buildListTile(
    ...
    return Padding(
      ...
      child: ListTile(
        ...
        onTap: onTap,
        tileColor: _backgroundImage == 'assets/images/img0.png'
